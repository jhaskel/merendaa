...
public interface ItensRepository extends JpaRepository<Itens, Long> {
    ...
    @Query(value = "SELECT *,SUM(total) AS tots ,SUM(quantidade) as quant unidade as nomec FROM itens where ano = :ano group BY produto ORDER BY quant desc", nativeQuery = true)
